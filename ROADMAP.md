...
- [x] **P7.02** — Implémenter l'énumération exhaustive des motifs maximaux pour instances bornées (types et demandes petits) avec génération paresseuse et garde-fou mémoire.
...
- [x] **P8.02** — Ajouter le multi-formats de barres (2 à 3 longueurs de stock) comme variante monodimensionnelle déclarée, schéma et validations inclus.
- [x] **P8.03** — Créer des profils de demande structurée défavorables à l'arrondi du maître restreint (divisibilité difficile, ratios tendus) et vérifier qu'ils produisent des trous entiers non triviaux.
...
- [x] **P8.10** — Publication du bilan de phase, mise à jour du README et validation de la phase 8.
...
- [x] **P9.03** — Introduire PyTorch comme dépendance justifiée et versionnée, avec entraînement reproductible : graines, checkpoints versionnés, courbes persistées.
- [x] **P9.04** — Baseline d'apprentissage par imitation du choix exact sur petites instances, afin de valider l'interface avant tout RL profond.
